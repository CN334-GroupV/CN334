    ...
    <div class='login-form'>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class='login-input'>
                ...
                <x-jet-input class="email" type="email" name="email" :value="old('email')" required autofocus />
                <br>
                <x-jet-label class='password-label' value="{{ __('Password') }}" />
                <x-jet-input class="password" type="password" name="password" required autocomplete="current-password" />
                ...
                <button class="loginbutton btn btn-outline-warning">
                    {{ __('Login') }}
                </button>
                </div>
            </div>
